...
for (j in 1:10){  # simulate genotypes and trait as usual
  ...
  setwd("/dscrhome/yy222/fix_k/k_10_n_1000")
write.table(M_auc, file="auc_k_fixed_k_10_pcs_1_90_n_1000_10_30_repeat_10.txt")
write.table(M_rmsd, file="rmsd_k_fixed_k_10_pcs_1_90_n_1000_10_30_repeat_10.txt")
