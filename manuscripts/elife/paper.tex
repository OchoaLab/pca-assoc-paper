...
% path of images % HACK eventually should copy and/or rename?
\graphicspath{ {../../data/} }

\begin{figure}
  \begin{fullwidth}
    \includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{kinship.pdf}
    \caption{
...
Lastly, we simulated traits with both low heritability and large environment effects determined by geography and subpopulation labels, so they are strongly correlated to the low-dimensional population structure (\TABLE{trait-var-sim}).
