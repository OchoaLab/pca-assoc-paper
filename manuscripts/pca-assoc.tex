...
\pit are drawn from a given distribution (constructed to mimic each real dataset below).
...
Given \ft[P_w], the desired \ft[S_w] is calculated via the additive edge $\delta_w$ \citep{ochoa_fst1}:
\begin{equation}
...
\subsubsection{Fitting ancestral allele frequency distribution to real data}
