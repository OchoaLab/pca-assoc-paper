...
These improvements do not change the fact that the resulting PCs are nevertheless inadequate models of family or cryptic relatedness, so an LMM will continue to outperform them in that setting.
