...
% However, in this present work we do not calculate q-values; instead we focus on testing for the correctness of null p-value distributions (a prerequisite for acccurate q-value estimation) and on classification performance (for which ranking of loci by p-values suffice; q-values do not alter these rankings).
