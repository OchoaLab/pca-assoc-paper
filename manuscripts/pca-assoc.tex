...
\begin{table}[hb!]
  ...
  \begin{tabular}{l|ccc|ccccc}
    ...
    \cite{price_new_2010}        &  IF &    2 &    0.01 &          & CC &          &    1 & Mixed \\
    \cite{wu_comparison_2011}    &  IA &  2-4 &    0.01 &          & CC &\checkmark&   10 & Mixed \\
    \cite{liu_controlling_2011}  &  SA &  2-3 &       R &          &  Q &\checkmark&   10 & Tie \\
    ...
    \cite{song_testing_2015}     &  SA &  2-3 &       R &          &  Q &          &    3 & LMM \\
    ...
    This work                    & ATF &10-243&$\le$0.25&\checkmark&  Q &\checkmark& 0-90 & LMM \\
    \bottomrule
  \end{tabular}
  \begin{flushleft} 
...
%The large admixture simulation differs from previously published admixture association evaluations in featuring a larger number of ancestral populations ($K=10$) and more differentiation ($\Fst = 0.1$ for the admixed individuals).
...
Non-zero kinship can be inferred utilizing the tree simulations' distribution as a null, which allowing for a small fraction of false positives suggests kinship above 0.001 or 0.01 for these datasets.
