...
## setwd('test_yiqi')
setwd( paste0("/hpc/group/biostat/yy222/LMM_PCA_rep_n_", n_ind,"_family/rep1"))
...
setwd(paste0("/hpc/group/biostat/yy222/LMM_PCA_rep_n_", n_ind,"_family/rep1"))
# write outputs
write.table(M_auc_gcta, file = paste0("auc_gcta_n_", n_ind, "_4_11_family_1.txt") )
write.table(M_rmsd_gcta, file = paste0("rmsd_gcta_n_", n_ind, "_4_11_family_1.txt") )
write.table(M_auc, file = paste0("auc_pca_n_", n_ind, "_4_11_family_1.txt") )
write.table(M_rmsd, file = paste0("rmsd_pca_n_", n_ind, "_4_11_family_1.txt") )