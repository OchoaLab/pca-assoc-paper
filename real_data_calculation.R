...
if (lite)
  ...
  ############
   ...
   load("/dscrhome/yy222/real_data_set/admix_g20.RData")
  ...
  style <- read_tsv('style.txt', col_types = 'cci')
  for (pcs in c(100,200,300)){
  for (j in 1:3){  # simulate genotypes and trait as usual
...
write.table(M_auc, file="auc_k_fixed_k_10_pcs_extreme_n_100_10_3.txt")
write.table(M_rmsd, file="rmsd_k_fixed_k_10_pcs_extreme_n_100_10_3.txt")
