...
library(readr)       # to write kinship matrix
 ...
 name <- "LM"
  ...
  write.table(M_auc, file="auc_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_1.txt")
  write.table(M_rmsd, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_1.txt")
  write.table(M_auc_LMM_n_100, file="auc_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_GCTAPC_1.txt")
  write.table(M_rmsd_LMM_n_100, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_GCTAPC_1.txt")
  write.table(M_auc_LM_n_100, file="auc_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_LM_1.txt")
  write.table(M_rmsd_LM_n_100, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_LM_1.txt")
  write.table(M_auc_GCTA, file="auc_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_GCTA_1.txt")
  write.table(M_rmsd_GCTA, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_3_11_repeat_10_GCTA_1.txt")
