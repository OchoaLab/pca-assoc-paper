...
option_list = list(
  ...
  make_option("--debug", action = "store_true", default = FALSE, 
    ...
    make_option("--rep", type = "integer", default = 1, 
...
library(readr)       # to write kinship matrix
  ...
  M_rmsd_LM_n_1000<-rep(NA,rep)
  M_auc_LM_n_1000<-rep(NA,rep)
  M_rmsd_LMM_n_1000<-matrix(0,rep,90)
  M_auc_LMM_n_1000<-matrix(0,rep,90)
 ...
 name <- "LM"
    ...
    pvals[[name]] <- obj$pvals
      ...
      p_lmm<-pvals_auc_collect(name_out, causal_indexes, pvals, times_kin, times_gas, style=style)
      M_rmsd_LM_n_1000[i]<-unlist(p_lmm[1,1])
      M_auc_LM_n_1000[i]<-unlist(p_lmm[1,2])
  ...
  write.table(M_auc, file="auc_k_fixed_k_10_pcs_1_90_n_100_1_23_repeat_10_family_1.txt")
  write.table(M_rmsd, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_1_23_repeat_10_family_1.txt")
  write.table(M_auc_LMM_n_1000, file="auc_k_fixed_k_10_pcs_1_90_n_100_1_23_repeat_10_GCTAPC_family_1.txt")
  write.table(M_rmsd_LMM_n_1000, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_1_23_repeat_10_GCTAPC_family_1.txt")
  write.table(M_auc_LM_n_1000, file="auc_k_fixed_k_10_pcs_1_90_n_100_1_23_repeat_10_LM_family_1.txt")
  write.table(M_rmsd_LM_n_1000, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_1_23_repeat_10_LM_family_1.txt")
