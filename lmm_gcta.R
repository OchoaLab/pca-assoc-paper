...
M_rmsd_LMM_n_100<-c()
M_auc_LMM_n_100<-rep(0,10)
M_rmsd_LM_n_100<-rep(0,10)
M_auc_LM_n_100<-rep(0,10)
style <- read_tsv('style.txt', col_types = 'cci')
for (i in 1:10) {
  ...
  p1<-pvals_auc_collect(name_out, causal_indexes, pvals[1], times_kin, times_gas, style=style)
  p<-unlist(p1)
  M_auc_LMM_n_100[i]<-p1[2]
  M_rmsd_LMM_n_100[i]<-p1[1]
  
  p2<-pvals_auc_collect(name_out, causal_indexes, pvals[2], times_kin, times_gas, style=style)
  p<-unlist(p2)
  M_auc_LM_n_100[i]<-p2[2]
  M_rmsd_LM_n_100[i]<-p2[1]
  
    
  }
   
M_auc_LM_n_100<-unlist(M_auc_LM_n_100)
M_rmsd_LM_n_100<-unlist(M_rmsd_LM_n_100)

M_auc_LMM_n_100<-unlist(M_auc_LMM_n_100)
M_rmsd_LMM_n_100<-unlist(M_rmsd_LMM_n_100)
...
M_rmsd_LMM_n_1000<-rep(0,10)
M_auc_LMM_n_1000<-rep(0,10)
M_rmsd_LM_n_1000<-rep(0,10)
M_auc_LM_n_1000<-rep(0,10)
style <- read_tsv('style.txt', col_types = 'cci')
for (i in 1:10) {
  ...
  p1<-pvals_auc_collect(name_out, causal_indexes, pvals[1], times_kin, times_gas, style=style)
  p<-unlist(p1)
  M_auc_LMM_n_1000[i]<-p1[2]
  M_rmsd_LMM_n_1000[i]<-p1[1]
  
  p2<-pvals_auc_collect(name_out, causal_indexes, pvals[2], times_kin, times_gas, style=style)
  p<-unlist(p2)
  M_auc_LM_n_1000[i]<-p2[2]
  M_rmsd_LM_n_1000[i]<-p2[1]
  
  
}


M_auc_LM_n_1000<-unlist(M_auc_LM_n_1000)
M_rmsd_LM_n_1000<-unlist(M_rmsd_LM_n_1000)

M_auc_LMM_n_1000<-unlist(M_auc_LMM_n_1000)
M_rmsd_LMM_n_1000<-unlist(M_rmsd_LMM_n_1000)



write.table(M_auc_LM_n_1000, file="M_auc_LM_n_1000.txt")
write.table(M_rmsd_LM_n_1000, file="M_rmsd_LM_n_1000.txt")
write.table(M_auc_LMM_n_1000, file="M_auc_LMM_n_1000.txt")
write.table(M_rmsd_LMM_n_1000, file="M_rmsd_LMM_n_1000.txt")
write.table(M_auc_LM_n_100, file="M_auc_LM_n_100.txt")
write.table(M_rmsd_LM_n_100, file="M_rmsd_LM_n_100.txt")
write.table(M_auc_LMM_n_100, file="M_auc_LMM_n_100.txt")
write.table(M_rmsd_LMM_n_100, file="M_rmsd_LMM_n_100.txt")
...
M_rmsd_LMM_n_1000_family<-rep(0,10)
M_auc_LMM_n_1000_family<-rep(0,10)
M_rmsd_LM_n_1000_family<-rep(0,10)
M_auc_LM_n_1000_family<-rep(0,10)
style <- read_tsv('style.txt', col_types = 'cci')
for (i in 1:10) {
  ...
  p1<-pvals_auc_collect(name_out, causal_indexes, pvals[1], times_kin, times_gas, style=style)
  p<-unlist(p1)
  M_auc_LMM_n_1000_family[i]<-p1[2]
  M_rmsd_LMM_n_1000_family[i]<-p1[1]
  
  p2<-pvals_auc_collect(name_out, causal_indexes, pvals[2], times_kin, times_gas, style=style)
  p<-unlist(p2)
  M_auc_LM_n_1000_family[i]<-p2[2]
  M_rmsd_LM_n_1000_family[i]<-p2[1]
  
  
}


M_auc_LM_n_1000_family<-unlist(M_auc_LM_n_1000_family)
M_rmsd_LM_n_1000_family<-unlist(M_rmsd_LM_n_1000_family)

M_auc_LMM_n_1000_family<-unlist(M_auc_LMM_n_1000_family)
M_rmsd_LMM_n_1000_family<-unlist(M_rmsd_LMM_n_1000_family)




write.table(M_auc_LM_n_1000_family, file="M_auc_LM_n_1000_family.txt")
write.table(M_rmsd_LM_n_1000_family, file="M_rmsd_LM_n_1000_family.txt")
write.table(M_auc_LMM_n_1000_family, file="M_auc_LMM_n_1000_family.txt")
write.table(M_rmsd_LMM_n_1000_family, file="M_rmsd_LMM_n_1000_family.txt")
