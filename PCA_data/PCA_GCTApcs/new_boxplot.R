...
# small sample size
rmsd_pca_100 <- read_data('rmsd_k_fixed_k_10_pcs_1_90_n_100_2_22_repeat_10', 5)
auc_pca_100 <- read_data('auc_k_fixed_k_10_pcs_1_90_n_100_2_22_repeat_10', 5)

rmsd_gcta_100 <- read_data("rmsd_k_fixed_k_10_pcs_1_90_n_100_2_22_repeat_10_GCTAPC", 5)
auc_gcta_100 <- read_data("auc_k_fixed_k_10_pcs_1_90_n_100_2_22_repeat_10_GCTAPC", 5)

rmsd_lm_100 <- read_data("auc_k_fixed_k_10_pcs_1_90_n_100_2_22_repeat_10_LM", 5)
auc_lm_100 <- read_data("auc_k_fixed_k_10_pcs_1_90_n_100_2_22_repeat_10_LM", 5)

# large sample size
rmsd_pca_1000 <- read_data('rmsd_k_fixed_k_10_pcs_1_90_n_1000_2_10_repeat_10', 5)
auc_pca_1000 <- read_data('auc_k_fixed_k_10_pcs_1_90_n_1000_2_10_repeat_10', 5)

rmsd_gcta_1000 <- read_data("rmsd_k_fixed_k_10_pcs_1_90_n_1000_2_10_repeat_10_GCTAPC", 5)
auc_gcta_1000 <- read_data("auc_k_fixed_k_10_pcs_1_90_n_1000_2_10_repeat_10_GCTAPC", 5)

rmsd_lm_1000 <- read_data("auc_k_fixed_k_10_pcs_1_90_n_1000_2_10_repeat_10_LM", 5)
auc_lm_1000 <- read_data("auc_k_fixed_k_10_pcs_1_90_n_1000_2_10_repeat_10_LM", 5)

# family structure
rmsd_pca_1000_family <- read_data('rmsd_k_fixed_k_10_pcs_1_90_n_1000_2_22_repeat_10', 5, family = TRUE)
auc_pca_1000_family <- read_data('auc_k_fixed_k_10_pcs_1_90_n_1000_2_22_repeat_10', 5, family = TRUE)

rmsd_gcta_1000_family <- read_data("rmsd_k_fixed_k_10_pcs_1_90_n_1000_2_22_repeat_10_GCTAPC", 5, family = TRUE)
auc_gcta_1000_family <- read_data("auc_k_fixed_k_10_pcs_1_90_n_1000_2_22_repeat_10_GCTAPC", 5, family = TRUE)

rmsd_lm_1000_family <- read_data("rmsd_k_fixed_k_10_pcs_1_90_n_1000_2_22_repeat_10_LM", 5, family = TRUE)
auc_lm_1000_family <- read_data("auc_k_fixed_k_10_pcs_1_90_n_1000_2_22_repeat_10_LM", 5, family = TRUE)
...
boxplots_rmsd_auc <- function(
    ...
    rmsd_pca <- trim_matrix( rmsd_pca, r_max )
    auc_pca <- trim_matrix( auc_pca, r_max )
    rmsd_lmm <- trim_matrix( rmsd_lmm, r_max )
    auc_lmm <- trim_matrix( auc_lmm, r_max )
    # concatenate the fixed effects series
    rmsd_fixed <- cbind( rmsd_lm, rmsd_pca )
    auc_fixed <- cbind( auc_lm, auc_pca )
    # same for mixed effects, though the LMM with zero PCs is currently missing
    rmsd_mixed <- cbind( NA, rmsd_lmm )
    auc_mixed <- cbind( NA, auc_lmm )
...
boxplots_rmsd_auc(
    ...
    rmsd_lm = rmsd_lm_1000_family,
    rmsd_lmm = rmsd_gcta_1000_family,
    auc = auc_pca_1000_family,
    auc_lm = auc_lm_1000_family,
