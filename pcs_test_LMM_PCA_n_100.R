...
library(readr)       # to write kinship matrix
 ...
 name <- "LM"
  ...
  setwd("/dscrhome/yy222/LMM_PCA_rep_n_100")
  write.table(M_auc, file="auc_k_fixed_k_10_pcs_1_90_n_100_1_13_repeat_10_family.txt")
  write.table(M_rmsd, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_1_13_repeat_10_family.txt")
  write.table(M_auc_LMM_n_1000, file="auc_k_fixed_k_10_pcs_1_90_n_100_1_13_repeat_10_GCTAPC_family.txt")
  write.table(M_rmsd_LMM_n_1000, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_1_13_repeat_10_GCTAPC_family.txt")
  write.table(M_auc_LM_n_1000, file="auc_k_fixed_k_10_pcs_1_90_n_100_1_13_repeat_10_LM_family.txt")
  write.table(M_rmsd_LM_n_1000, file="rmsd_k_fixed_k_10_pcs_1_90_n_100_1_13_repeat_10_LM_family.txt")
